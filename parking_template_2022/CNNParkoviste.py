...
def main(argv):
    ...
    transform = transforms.Compose(
        [
            ...
            transforms.ColorJitter(brightness=0.7, contrast=0, saturation=0.0, hue=0),
    ...
    trainset = DatasetParking.DatasetParking(train_imgs, labels, transform)
    ...
    if train:
        net = CNN.Net()
        criterion = nn.CrossEntropyLoss()
        # TODO: zkus LogSoftmax loss funkci
        # TODO: zkus BCELoss loss funkci
        ...
        for epoch in range(epochs):  # loop over the dataset multiple times
            ...
            for i, data in enumerate(trainloader, 0):
                ...
                if i % 100 == 99:
                    print(f'[{epoch + 1}, {i + 1:5d}] loss: {running_loss / 100:.8f}') # puvodne misto 500 bylo 2000
                    running_loss = 0.0
    ...
    for img_name in test_images:
        ...
        for coord in pkm_coordinates:
            ...
            with torch.no_grad():
                sample = transform_eval(one_place)
